...
public class S3Load {
    public static final String BUCKET_NAME = "aws-publicdatasets";

    public static InputStream loadWATStream(String key) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        InputStream is = loadWATStream(path);
